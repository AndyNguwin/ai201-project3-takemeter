...
| Example | Text | Possible Labels | Final Label | Decision Reasoning |
| --- | --- | --- | --- | --- |
| 1 | "[Difficult example text]" | [Label A / Label B] | [Chosen label] | [Why you chose this label despite ambiguity] |
| 2 | "[Difficult example text]" | [Label A / Label B] | [Chosen label] | [Why you chose this label despite ambiguity] |
| 3 | "[Difficult example text]" | [Label A / Label B] | [Chosen label] | [Why you chose this label despite ambiguity] |
